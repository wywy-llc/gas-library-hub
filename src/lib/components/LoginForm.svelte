<script lang="ts">
  import { login_description, login_title, login_with_google } from '$lib/paraglide/messages.js';
...
<div class="card card-bordered bg-base-100 mx-auto max-w-md shadow-xl">
  <div class="card-body">
    <h2 class="card-title mb-6 justify-center text-2xl">{login_title()}</h2>

    <div class="space-y-4">
      <p class="text-center text-sm opacity-70">{login_description()}</p>
